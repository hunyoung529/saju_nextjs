          ...
          <ul className={bord.board_main_buttons}>
            <li>
              <button
                className={
                  bord.navibutton +
                  ` ${activeComponent === "board" ? bord.active : ""}`
                }
                onClick={() => handleButtonClicked("board")}
              >
                공지사항
              </button>
            </li>
            <li>
              <button
                className={
                  bord.navibutton +
                  ` ${activeComponent === "community" ? bord.active : ""}`
                }
                onClick={() => handleButtonClicked("community")}
              >
                자유게시판
              </button>
            </li>
